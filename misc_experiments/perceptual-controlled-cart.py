...
# initial conditions
Xb = .0 	# pendulum position
Vb = .0		# pendulum velocity
dX = 0		# cart position - pendulum position
Vc = .0		# cart velocity
...
fig = pp.figure()
ax = fig.add_subplot(111, autoscale_on=False, xlim=(-3.5, 3.5), ylim=(-0.5, 2))
ax.set_aspect('equal')
ax.grid()
